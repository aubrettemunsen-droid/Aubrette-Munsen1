...
export const INDUSTRY_PRESETS: Record<IndustryType, {
    ...
    agents: [
      {
        id: 'a_ceo',
        name: 'Sophia',
        title: 'Operations CEO Agent',
        role: 'Orchestrates the entire store, analyzes weekly commercial performance metrics, delegates optimization tasks to downstream teams, and presents final strategic decisions.',
        status: 'Idle',
        emoji: '🧠',
        description: 'Enterprise brain aggregating data logs and making ROI budgeting calls.',
        capabilities: ['Multitask delegation', 'RAG commercial analytics', 'Financial cost constraints modeling'],
        systemPrompt: 'You are Sophia, the high-level Enterprise CEO Agent. Your response should be insightful, structured, focused on maximizing profit margins, reducing risk, and making active recommendations. Use concise, bulleted strategic directions.',
      ...
      },
      {
        id: 'a_mktg',
        name: 'Marcus',
        title: 'AI Marketing & Advertising Lead',
        role: 'Monitors pixel tracking, computes CPC, CPM, and active ROAS on TikTok, Meta, and Google ads. Launches discounts.',
        status: 'Idle',
        emoji: '📣',
        description: 'Growth and demand generation agent optimized for advertising efficiency.',
        capabilities: ['Conversion Rate optimization', 'Dynamic Coupon Configuration', 'Creative copywriting gen'],
        systemPrompt: 'You are Marcus, the creative and analytical Growth Marketing Lead. You think in terms of copy hooks, viral potential, A/B test parameters, and CPA limits.',
        model: 'gemini-3.5-flash',
        tasksCompleted: 312
      },
      {
        id: 'a_support',
        name: 'Emily',
        title: 'AI Customer Experience Supervisor',
        role: 'Reads client emails, triggers order status queries, conducts refunds automated threat/fraud checks, and handles customer FAQ answers.',
        status: 'Idle',
        emoji: '💬',
        description: 'RAG-grounded support desk fluent in refund SLAs and polite hospitality.',
        capabilities: ['Grounding RAG query', 'High-Risk Refund Detection', 'Multilingual support response'],
        systemPrompt: 'You are Emily, the Customer Support Lead. You speak warmly, politely, and structure your responses clearly. You have access to active FAQ lookup data.',
        model: 'gemini-3.5-flash',
        tasksCompleted: 980
      }
    ],
    workflows: [
      ...
      },
      {
        ...
        nodes: [
          ...
          { id: 'n2', type: 'ai_decision', title: 'Logistics SLA & IP Risk Scan', status: 'idle', details: 'Emily evaluates delivery confirmation logs of last-mile postal provider' },
    ...
    workflows: [
      {
        ...
        nodes: [
          ...
          { id: 'n2', type: 'ai_decision', title: 'Dynamic Promo Calculation', status: 'idle', details: 'Liam calculates optimal bundle price of Wagyu Burgers to dump excess stock' },
          { id: 'n3', type: 'action', title: 'Auto-Update Menu Pricing', status: 'idle', details: 'Updates Shopify-Diner SKU price to $18.50 (20% off)' },
          { id: 'n4', type: 'action', title: 'Dispatch Geo-Fenced Push Ads', status: 'idle', details: ' Marcus launches geo-fenced Instagram and SMS ads: "Wagyu Flash-Day at Diner!"' }
        ]
      }
    ],
    knowledge: [
  ...
  education: {
    ...
    orders: [
      { id: '#ORD-2004', customerName: 'Sophia Patel', contact: 'sophia.patel@educate.io', total: 699.00, status: 'Pending', createdAt: '2026-06-07 20:10', riskScore: 2 },
    ...
    agents: [
      {
        id: 's_ceo',
        name: 'Zoe',
        title: 'Local Services operations Director',
        role: 'Manitors calendar utilization rates, coordinates cross-selling of service gift coupons, sets staff scheduling optimization budgets.',
        status: 'Idle',
        emoji: '💅',
        description: 'Operations director targeting appointment fill rates and staff rosters.',
        capabilities: ['Slot fill modeling', 'Cross-sell coupon triggers', 'Roster balancing'],
        systemPrompt: 'You are Zoe, the Local Services operations Director. You talk about maximizing scheduling efficiency, high-trust client relationships, and premium service consistency.',
        model: 'gemini-3.5-flash',
        tasksCompleted: 190
      },
      {
        id: 's_scheduler',
        name: 'Mia',
        title: 'AI Front Desk & Booking Assistant',
        role: 'Manages member bookings, drafts SMS appointment reminders, handles cancellation fee inquiries and slot rescheduling.',
        status: 'Idle',
        emoji: '📅',
        description: 'Warm, swift scheduling agent connected directly to staff rosters.',
        capabilities: ['Roster Lookup', 'Cancellation policy checking', 'VIP spot reservation'],
        systemPrompt: 'You are Mia, the expert Front Desk Coordinator. You are organized, prompt, friendly, and speak with extreme clarity regarding reservation dates, opening hours, and policies.',
        model: 'gemini-3.5-flash',
        tasksCompleted: 1290
      }
    ],
    workflows: [
      {
        ...
        nodes: [
          ...
          { id: 'n2', type: 'ai_decision', title: 'Identify Nearby Active Customers', status: 'idle', details: 'Mia targets top 15 regular active local VIP members' },
